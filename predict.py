...
def decoder(pred):
            ...
            for b in range(2):
                ...
                if mask[i,j,b] == 1:
                    ...
                    if float((contain_prob*max_prob)[0]) > 0.1:
                        ...
                        cls_indexs.append(cls_index.unsqueeze(dim=-1)) # 对cls_index 扩展一个维度
    ...
    if len(boxes) ==0:
        ...
        # print('cls_index:{}'.format(cls_indexs))
...
if __name__ == '__main__':
    ...
    cv2.imwrite('./fig/result.jpg',image)
    print('done !')
